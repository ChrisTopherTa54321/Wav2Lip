...
def main(args):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        if not args.audio.endswith('.wav'):
            ...
            command = 'ffmpeg -y -i {} -strict -2 {}'.format(args.audio, temp_wav_path)

            subprocess.call(command, shell=True)
            args.audio = temp_wav_path
        ...
        intermediate_filename = os.path.join(temp_dir, "intermediate.avi")
        for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen,
            ...
            if i == 0:
                ...
                out = cv2.VideoWriter(intermediate_filename,
        ...
        command = 'ffmpeg -y -i {} -i {} -strict -2 -q:v 1 {}'.format(args.audio, intermediate_filename, args.outfile)
